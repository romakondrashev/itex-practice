                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="login_form">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox"><input name="remember_ip" class="custom-control-input" id="rememberPasswordCheck" type="checkbox" checked="checked" /><label class="custom-control-label" for="rememberPasswordCheck">Remember ip</label></div>
                                            </div>
